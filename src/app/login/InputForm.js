...
const InputForm = () => {
  ...
  const submitData = () => {
    ...
    //   if (data.state) {
    //     router.push(`/dashboard?student=${username}`);
    //     setUsername("");
    //     setPassword("");
    //   }
    // } catch (e) {
      ...
      <section className="bg-gray-100 min-h-screen flex items-center justify-center">
        ...
        <div className="bg-white flex rounded-2xl shadow-2xl p-5">
          ...
          <div className="md:block hidden w-1/2 bg-[#E23744] text-white rounded-2xl py-4 px-4 shadow-gray-600 shadow-lg ">
            ...
            <div className="flex flex-col items-center justify-center">
              <button
                ...
                className="border-2 border-white rounded-xl px-8 py-2 inline-block font-semibold hover:bg-white hover:text-[#E23744] mt-2 "
              >
                SignIn
              </button>
            </div>
          ...
          <div className="md:w-1/2 px-16">
            <h2 className="font-bold text-2xl text-[#E23744]">Login Here</h2>
